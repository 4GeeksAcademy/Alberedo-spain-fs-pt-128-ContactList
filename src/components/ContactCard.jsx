                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h1 className="modal-title fs-5" id="exampleModalLabel"><i class="fa-solid fa-triangle-exclamation text-danger"></i>  ¡Warning!  <i class="fa-solid fa-triangle-exclamation text-danger"></i></h1>
